...
BEGIN
  ...
  -- 1. Import chat_sessions (must come before chat_messages due to FK)
  _count := 0;
  ...
  -- 7. Import evolution_chains (parent first, then children — sorted by generation)
  _count := 0;
  ...
  -- 12. Import used_elements (user_id is TEXT!)
  _count := 0;
